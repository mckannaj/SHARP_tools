% Zephy McKanna
% Script to convert the parsed Pilot3 RF categorization data into a form that M&M want 
% 11/2/16



% Convert Pilot2 CLT data into a useful form for Misha and Maciej
[zRFP3_data, zRFP3_sum, zRFP3_all] = formTables_RF_1A3('2a-latest-rf-data.xlsx', '2a-latest-rf-sum.xlsx', '2a-latest-rf-trials.00.xlsx', true);
